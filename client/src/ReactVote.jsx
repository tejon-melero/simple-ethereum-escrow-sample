    ...
    return (
      <div className="voteWrapper" >
        {data.title && !showSetting
          ? (
            <div id={isVotingClosed ? 'result-view' : 'vote-view'} className="container">
              {isAdmin && onEdit &&
              <button className="settingButton" onClick={this.goToSetting}>{text.settingButtonText}</button>}
              <div className="voteTitle">{data.title}</div>
              <VoteItems
                voted={voted}
                data={data}
                styles={styles}
              ...
              <div className={styles.buttonWrapper}>
                {!data.closed &&
                <button
                  className={showResult ? "goBackButton" : "resultButton"}
